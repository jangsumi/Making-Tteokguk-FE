        ...
        <styled.NoModalContainer>
            ...
            <styled.TextWrapper>
                ...
                <styled.LongText>
                        ...
                        그런데 냉장고에 재료가 하나도 없는 거 있죠...
                        어쩔 수 없이 친구들에게 재료를 사 와달라고 부탁했답니다.
                        <styled.ColorText> 떡국 재료 4개</styled.ColorText>를 모아서 떡국을 만들어 볼까요?
                </styled.LongText>
                ...
                <div>
                    ...
                    <styled.LongText fontSize={14}>
                        <styled.ColorText>‘비밀의 재료’</styled.ColorText>가 존재한다는 사실을 아시나요?
                        <styled.ColorText> 로그인한 상태로 친구에게 덕담을 작성</styled.ColorText>하면 비밀의 재료를 하나씩 얻을 수 있어요.
                        지금 떡국 재료가 1개밖에 없다면, 비밀의 재료를 3개 모으면 되겠죠?
                        로그인한 채로 덕담을 보내도 익명은 유지되니 걱정 마세요.
                    </styled.LongText>
                </div>
